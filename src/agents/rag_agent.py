"""
Agente RAG para el sistema de Recomendación de Posgrados ICESI
Maneja la lógica de recuperación y generación de respuestas sobre programas académicos
"""
...
# Herramientas para gestión de información de posgrados
# (Las herramientas de tickets se mantienen para funcionalidades administrativas)
from tools.ticket_manager import (
    consultar_ticket, extraer_info_cliente
)
...
class PosgradoAgent:
    """
    Agente RAG para responder consultas sobre programas de posgrado de ICESI
    usando documentos académicos y bases de conocimiento
    """
    ...
    @traceable(name="PosgradoAgent.process_query")
    def process_query(self, question: str, enable_logging: bool = False, trace_id: str = None) -> str:
        ...
        try:
            ...
            # Paso 2: Si es una consulta de lista, usar estrategia de lista
            if query_info['is_list_query']:
                ...
                # Paso 3: Usar estrategia estándar con herramientas
...
"""
    ...
    def _get_ticket_help_response(self) -> str:
        """Respuesta de ayuda para consultas administrativas"""
        return """
[LIST] **Sistema de Recomendación de Posgrados ICESI**

Puedo ayudarte con:
- [OK] Información sobre programas de posgrado
- [OK] Consultas sobre requisitos y admisiones
- [OK] Información sobre costos y financiación
- [OK] Consultar estado de solicitudes
- [OK] Recomendaciones personalizadas de programas
...
"""
    ...
    def _get_fallback_response(self) -> str:
        ...
        Por favor, contacta directamente con nuestro equipo de admisiones:
        - [EMAIL] Email: admisiones@icesi.edu.co
        - 📞 Teléfono: +57 (2) 555 2334
        - [TIME] Horario: Lunes a Viernes 8:00 AM - 6:00 PM
        """
